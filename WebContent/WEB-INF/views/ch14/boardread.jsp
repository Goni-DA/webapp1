			...
			<div class="mainCenter">
				...
				<div class="content">
					<div class="sector">
						...
						<form name="boardreadform" action="boardread" method="post">
						  ...
						  <div class="form-group">
							    ...
							    <textarea class="form-control" id="bcontent" name="bcontent" rows="4" cols="50" readonly>${board.bcontent}</textarea>
						  </div>
						   <div class="form-group">
